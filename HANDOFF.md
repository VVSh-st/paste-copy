...
22. ✅ **mindmap.js** — новый модуль. Кнопка 🧠 в шапке превью. LLM анализирует текст → JSON (слова, связи, кластеры, дерево аргументов). 4 режима: W/G/T/C. Оверлей с backdrop-filter, кнопки плавно появляются при hover. Escape/ПКМ закрывают
...
- `mindmap.js` (~300 строк) — MindMap: SVG-визуализация (слова/граф/дерево/кластеры)
