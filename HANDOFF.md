...
**Итого: 340 фиксов за 31 раунд аудита**
...
- `intelligence-core.js` (~1563 строк) — ядро интеллектуальных подсказок, scoring, prediction, GPT audit fixes (49 fixes, 4 раунда)
