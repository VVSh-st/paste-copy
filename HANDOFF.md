...
**Итого: 331 фикс за 30 раундов аудита**
...
- `intelligence-core.js` (~1531 строк) — ядро интеллектуальных подсказок, scoring, prediction, GPT audit fixes (40 fixes, 3 раунда)
