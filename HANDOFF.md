...
2. ✅ **Ctrl+K** — popup с полем ввода запроса
3. ✅ **Кнопка в футере блока** — иконка часов перед тезаурусом
4. ✅ **Popup в стиле UI** — минималистичный, без робота
5. ✅ **Diff как snap-diff** — единый стиль с существующим diff
6. ✅ **Автоприменение** — через 5 сек если не отменено
7. ✅ **Клик ЛКМ вне** — закрыть (не принимать), ПКМ — отмена
