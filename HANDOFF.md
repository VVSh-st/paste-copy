...
20. ✅ **Меню по долгому клику** — 400мс удержание на кнопке «Тезаурус»: выпадающее меню с пунктами «Антонимы», «Перефразирование», «Объяснение», «Структурирование». Выбор запоминается в localStorage
...
19. ✅ **Меню по долгому клику** — 400мс удержание на кнопке «Тезаурус»: выпадающее меню с пунктами «Антонимы», «Перефразирование», «Объяснение», «Структурирование». Выбор запоминается в localStorage
