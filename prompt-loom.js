...
(function () {
  ...
  function renderUltraLightCard(item, source) {
    ...
    const wrappedText = ultraWrapText(item.text, 15);
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      .pl-ultra-text { font-size: 9.5px; line-height: 1.35; font-family: inherit; color: var(--text1); white-space: pre; overflow: clip; max-height: calc(1.35em * 3 + 2px); word-break: normal; letter-spacing: -0.01em; padding-right: 20px; }
